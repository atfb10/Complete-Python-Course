...
non_yosemite_friends = friends.difference(yosemite_friends)
print(non_yosemite_friends)
print('\n')

# Gets who is NOT in both sets
not_in_both = friends.symmetric_difference(yosemite_friends)
print(not_in_both)
print('\n')

# Gets who is in both sets
both_friends = friends.intersection(yosemite_friends)
print(both_friends)

# Create set of everyone, but will not make a duplicate (AKA only 1 bella)
all_friends = friends.union(yosemite_friends)
print('\n')
print(all_friends)